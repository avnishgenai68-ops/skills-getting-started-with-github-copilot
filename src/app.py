...
activities = {
    ...
    "Debate Team": {
        "description": "Competitive debate training and inter-school debates",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["benjamin@mergington.edu", "eva@mergington.edu"]
    },
    "Chess Club": {
...
def unregister_participant(activity_name: str, email: str = Body(..., embed=True)):
